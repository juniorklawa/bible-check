...
public class ntGalatas extends Activity implements CompoundButton.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nt_galatas);
        ...
        cb1.setChecked(getFromSP("gl1"));
        cb1.setOnCheckedChangeListener(this);

        cb2 = (CheckBox)findViewById(R.id.checkBox2);
        cb2.setChecked(getFromSP("gl2"));
        cb2.setOnCheckedChangeListener(this);

        cb3 = (CheckBox)findViewById(R.id.checkBox3);
        cb3.setChecked(getFromSP("gl3"));
        cb3.setOnCheckedChangeListener(this);

        cb4 = (CheckBox)findViewById(R.id.checkBox4);
        cb4.setChecked(getFromSP("gl4"));
        cb4.setOnCheckedChangeListener(this);

        cb5 = (CheckBox)findViewById(R.id.checkBox5);
        cb5.setChecked(getFromSP("gl5"));
        cb5.setOnCheckedChangeListener(this);

        cb6 = (CheckBox)findViewById(R.id.checkBox6);
        cb6.setChecked(getFromSP("gl6"));
    ...
    public void onCheckedChanged(CompoundButton buttonView,
        ...
        switch(buttonView.getId()){
            case R.id.checkBox1:
                saveInSp("gl1",isChecked);
                break;
            case R.id.checkBox2:
                saveInSp("gl2",isChecked);
                //text.setText(capitulosLidos);
                break;
            case R.id.checkBox3:
                saveInSp("gl3",isChecked);
                //text.setText(capitulosLidos);
                break;
            case R.id.checkBox4:
                saveInSp("gl4",isChecked);
                //text.setText(capitulosLidos);
                break;
            case R.id.checkBox5:
                saveInSp("gl5",isChecked);
                //text.setText(capitulosLidos);
                break;
            case R.id.checkBox6:
                saveInSp("gl6",isChecked);
                //text.setText(capitulosLidos);
                break;
    ...
    public void salvarCapitulos() {
        ...
        SharedPreferences.Editor editor = preferences.edit();
        editor.putFloat("CapGalatas",capitulosLidos);
        editor.commit();
    }
    ...
    public void carregarCapitulos() {
        ...
        SharedPreferences preferences = getApplicationContext().getSharedPreferences("PROJECT_NAME", android.content.Context.MODE_PRIVATE);
        capitulosLidos = preferences.getFloat("CapGalatas", capitulosLidos);
