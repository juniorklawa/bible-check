...
public class vtJoel extends Activity implements CompoundButton.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vt_joel);
        ...
        cb1.setChecked(getFromSP("joell1"));
        cb1.setOnCheckedChangeListener(this);

        cb2 = (CheckBox)findViewById(R.id.checkBox2);
        cb2.setChecked(getFromSP("joell2"));
        cb2.setOnCheckedChangeListener(this);

        cb3 = (CheckBox)findViewById(R.id.checkBox3);
        cb3.setChecked(getFromSP("joell3"));
    ...
    public void onCheckedChanged(CompoundButton buttonView,
        ...
        switch(buttonView.getId()){
            case R.id.checkBox1:
                saveInSp("joell1",isChecked);
                break;
            case R.id.checkBox2:
                saveInSp("joell2",isChecked);
                //text.setText(capitulosLidos);
                break;
            case R.id.checkBox3:
                saveInSp("joell3",isChecked);
                //text.setText(capitulosLidos);
                break;
    ...
    public void salvarCapitulos() {
        ...
        SharedPreferences.Editor editor = preferences.edit();
        editor.putFloat("CapJoel",capitulosLidos);
        editor.commit();
    }
    ...
    public void carregarCapitulos() {
        ...
        SharedPreferences preferences = getApplicationContext().getSharedPreferences("PROJECT_NAME", android.content.Context.MODE_PRIVATE);
        capitulosLidos = preferences.getFloat("CapJoel", capitulosLidos);
