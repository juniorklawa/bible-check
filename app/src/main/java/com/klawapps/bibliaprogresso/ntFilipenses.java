...
public class ntFilipenses extends Activity implements CompoundButton.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nt_filipenses);
        ...
        cb1.setChecked(getFromSP("fl1"));
        cb1.setOnCheckedChangeListener(this);

        cb2 = (CheckBox)findViewById(R.id.checkBox2);
        cb2.setChecked(getFromSP("fl2"));
        cb2.setOnCheckedChangeListener(this);

        cb3 = (CheckBox)findViewById(R.id.checkBox3);
        cb3.setChecked(getFromSP("fl3"));
        cb3.setOnCheckedChangeListener(this);

        cb4 = (CheckBox)findViewById(R.id.checkBox4);
        cb4.setChecked(getFromSP("fl4"));
    ...
    public void onCheckedChanged(CompoundButton buttonView,
        ...
        switch(buttonView.getId()){
            case R.id.checkBox1:
                saveInSp("fl1",isChecked);
                break;
            case R.id.checkBox2:
                saveInSp("fl2",isChecked);
                //text.setText(capitulosLidos);
                break;
            case R.id.checkBox3:
                saveInSp("fl3",isChecked);
                //text.setText(capitulosLidos);
                break;
            case R.id.checkBox4:
                saveInSp("fl4",isChecked);
                //text.setText(capitulosLidos);
                break;
            case R.id.checkBox5:
                saveInSp("fl5",isChecked);
                //text.setText(capitulosLidos);
                break;
            case R.id.checkBox6:
                saveInSp("fl6",isChecked);
                //text.setText(capitulosLidos);
                break;
    ...
    public void salvarCapitulos() {
        ...
        SharedPreferences.Editor editor = preferences.edit();
        editor.putFloat("CapFilipenses",capitulosLidos);
        editor.commit();
    }
    ...
    public void carregarCapitulos() {
        ...
        SharedPreferences preferences = getApplicationContext().getSharedPreferences("PROJECT_NAME", android.content.Context.MODE_PRIVATE);
        capitulosLidos = preferences.getFloat("CapFilipenses", capitulosLidos);
